...
_HIST_RAMP = ["#08306B", "#08519C", "#2171B5", "#4292C6", "#6BAED6", "#9ECAE1"]   # blues
_MED_RAMP = ["#00441B", "#006D2C", "#238B45", "#41AB5D"]                          # greens

_SCALE_COLORS = {"MMSE": "#7B3294", "COG": _OKABE["skyblue"], "BMI": _OKABE["orange"]}
_EVENTS = [n for n in _pd.EVENT_NAMES]
_COMORBID = [n for n in _EVENTS if "Antihyp" not in n and "Statin" not in n]
_MEDS = [n for n in _EVENTS if "Antihyp" in n or "Statin" in n]
