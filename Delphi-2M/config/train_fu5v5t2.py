# Delphi-2M on cohort B: follow-up > 5 y, >= 5 visits, >= 2 transitions
#
...
#
#   cohort B: ~2,296 train / ~694 test patients
#   (for reference: the general model trains on 16,262)
#
# Built by:
#   python data_prep/make_cohort_strict.py --csv <raw> \
#       --tag nacc-fu5v5t2-s42 --fu-years 5 --min-visits 5 --min-trans 2
#
...
#
# Run: python training/train.py config/train_fu5v5t2.py --device=cuda
dataset = "nacc-fu5v5t2-s42"
out_dir = "out-fu5v5t2-s42"
...
wandb_run_name = "delphi2m-fu5v5t2-s42"
