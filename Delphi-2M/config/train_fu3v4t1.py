# Delphi-2M on cohort D: follow-up > 3 y, >= 4 visits, >= 1 transition
#
...
#
#   cohort D: ~5,930 train / ~1,747 test patients
#   (for reference: the general model trains on 16,262)
#
# Built by:
#   python data_prep/make_cohort_strict.py --csv <raw> \
#       --tag nacc-fu3v4t1-s42 --fu-years 3 --min-visits 4 --min-trans 1
#
...
#
# Run: python training/train.py config/train_fu3v4t1.py --device=cuda
...
wandb_run_name = "delphi2m-fu3v4t1-s42"
